...
const useStyles = makeStyles((theme) => ({
  ...
  b1:{
    width: 300, marginTop: '2px',marginBottom:'2px' 
  }
}))
          ...
          <Grid item className={classes.grid1}>
            <div className={classes.div1}>
              <FormControl  className={classes.formcontrol}>
                <FormControl  classes={classes.f1}>Username
                ...
                <FormControl className={classes.f1}>email-id
                  <TextField className={classes.l2}
                    name="email"
                    helperText={iemail}
                    value={email}
                ...
                <FormControl className={classes.f1}>Phone-number
                  <TextField className={classes.l2}
                    inputProps={{
                      maxLength: 10,
                    }}
                ...
                <FormControl  className={classes.f1}>Create a password
                  <TextField className={classes.l2}
                    type="password"
                ...
                <Button variant="contained" color='success' className={classes.b1} sx={{ }} onClick={navigate}> submit </Button>
              </FormControl>
            </div>
          </Grid>
